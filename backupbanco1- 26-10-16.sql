...
--
-- Host: mysql04-farm58.kinghost.net
-- Tempo de geração: 26/10/2016 às 09:41
...
--
-- Banco de dados: `sgagro`
--

-- --------------------------------------------------------

--
-- Estrutura para tabela `sl_adm`
--
...
--
-- Fazendo dump de dados para tabela `sl_adm`
--
...
--
-- Estrutura para tabela `sl_artigo`
--
...
--
-- Fazendo dump de dados para tabela `sl_artigo`
--
...
--
-- Estrutura para tabela `sl_avaliador`
--
...
--
-- Fazendo dump de dados para tabela `sl_avaliador`
--
...
(37, 'Camila Andrea', 'Jaboticabal', 'Rua Campos Bicudo', 'estudante', 'UNESP-FCAV', '(16) 99109 - 8641', '', 'camila_aquinosg@hotmail.com', '0');

-- --------------------------------------------------------

--
-- Estrutura para tabela `sl_cadusu`
--
...
--
-- Fazendo dump de dados para tabela `sl_cadusu`
--
...
(134, '', 'camila_aquinosg@hotmail.com', 1, 'pingo1806', '2016-05-01 12:09:00', '', 'Camila Andrea', 'Aquino Segura', '455.997.758-52', '12/11/1997', 'Feminino', 'Rua Campos Bicudo', '', '191', 'Recreio dos Bandeirantes', '14.883-412', 'Jaboticabal', 'SP', 'Brasil', 'UNESP-FCAV', '(16) 99109 - 8641', '', 0, 'Avaliador', 'estudante', 'Estratégia, Planejamento e Governança', 0);

-- --------------------------------------------------------

--
-- Estrutura para tabela `sl_correcoes`
--
...
--
-- Fazendo dump de dados para tabela `sl_correcoes`
--
...
--
-- Estrutura para tabela `sl_grupo`
--
...
--
-- Fazendo dump de dados para tabela `sl_grupo`
--
...
(76, 35, 69, 71, 81, 75, 70, 69),
(77, 37, 51, 78, 52, 0, 0, 51);

-- --------------------------------------------------------

--
-- Estrutura para tabela `sl_notas`
--
...
--
-- Fazendo dump de dados para tabela `sl_notas`
--
...
--
-- Estrutura para tabela `sl_notas2`
--
...
--
-- Fazendo dump de dados para tabela `sl_notas2`
--
...
--
-- Estrutura para tabela `sl_status`
--
...
--
-- Estrutura para tabela `sl_trabcorrigido`
--
...
--
-- Fazendo dump de dados para tabela `sl_trabcorrigido`
--
...
--
-- Estrutura stand-in para view `trabaprovados`
--
CREATE TABLE IF NOT EXISTS `trabaprovados` (
`id_artigo` int(11)
,`criado` varchar(10)
,`titulo` varchar(700)
,`resumo` varchar(2400)
...
,`id_avaliador1` varchar(50)
,`id_avaliador2` varchar(50)
,`avaliacao_concluida1` int(11)
,`avaliacao_concluida2` int(11)
);

-- --------------------------------------------------------

--
-- Estrutura stand-in para view `trabautores`
--
CREATE TABLE IF NOT EXISTS `trabautores` (
`area` varchar(200)
,`resumo` varchar(2400)
,`titulo` varchar(700)
,`categoria` varchar(50)
...
--
-- Estrutura para view `trabaprovados`
--
DROP TABLE IF EXISTS `trabaprovados`;

CREATE ALGORITHM=UNDEFINED DEFINER=`sgagro`@`%` SQL SECURITY INVOKER VIEW `trabaprovados` AS select `sl_artigo`.`id_artigo` AS `id_artigo`,`sl_artigo`.`criado` AS `criado`,`sl_artigo`.`titulo` AS `titulo`,`sl_artigo`.`resumo` AS `resumo`,`sl_artigo`.`area` AS `area`,`sl_artigo`.`coautor` AS `coautor`,`sl_artigo`.`apresentacao` AS `apresentacao`,`sl_artigo`.`orientador` AS `orientador`,`sl_artigo`.`descricao` AS `descricao`,`sl_artigo`.`categoria` AS `categoria`,`sl_artigo`.`idartigo` AS `idartigo`,`sl_artigo`.`email` AS `email`,`sl_artigo`.`status` AS `status`,`sl_artigo`.`instituicao` AS `instituicao`,`sl_artigo`.`id_avaliador1` AS `id_avaliador1`,`sl_artigo`.`id_avaliador2` AS `id_avaliador2`,`sl_artigo`.`avaliacao_concluida1` AS `avaliacao_concluida1`,`sl_artigo`.`avaliacao_concluida2` AS `avaliacao_concluida2` from `sl_artigo` where ((`sl_artigo`.`avaliacao_concluida1` = 1) and (`sl_artigo`.`avaliacao_concluida2` = 1) and (`sl_artigo`.`status` = 1)) order by `sl_artigo`.`titulo`;

-- --------------------------------------------------------

--
-- Estrutura para view `trabautores`
--
DROP TABLE IF EXISTS `trabautores`;

CREATE ALGORITHM=UNDEFINED DEFINER=`sgagro`@`%` SQL SECURITY INVOKER VIEW `trabautores` AS select `t`.`area` AS `area`,`t`.`resumo` AS `resumo`,`t`.`titulo` AS `titulo`,`t`.`categoria` AS `categoria`,`t`.`idartigo` AS `idartigo`,`t`.`instituicao` AS `instituicao`,(select concat(`sl_cadusu`.`nome`,' ',`sl_cadusu`.`sobrenome`) AS `CONCAT(``nome``,' ',``sobrenome``)` from `sl_cadusu` where (`sl_cadusu`.`id_usuario` = `g`.`id_usuario1`)) AS `autor_1`,(select concat(`sl_cadusu`.`nome`,' ',`sl_cadusu`.`sobrenome`) AS `CONCAT(``nome``,' ',``sobrenome``)` from `sl_cadusu` where (`sl_cadusu`.`id_usuario` = `g`.`id_usuario2`)) AS `autor_2`,(select concat(`sl_cadusu`.`nome`,' ',`sl_cadusu`.`sobrenome`) AS `CONCAT(``nome``,' ',``sobrenome``)` from `sl_cadusu` where (`sl_cadusu`.`id_usuario` = `g`.`id_usuario3`)) AS `autor_3`,(select concat(`sl_cadusu`.`nome`,' ',`sl_cadusu`.`sobrenome`) AS `CONCAT(``nome``,' ',``sobrenome``)` from `sl_cadusu` where (`sl_cadusu`.`id_usuario` = `g`.`id_usuario4`)) AS `autor_4`,(select concat(`sl_cadusu`.`nome`,' ',`sl_cadusu`.`sobrenome`) AS `CONCAT(``nome``,' ',``sobrenome``)` from `sl_cadusu` where (`sl_cadusu`.`id_usuario` = `g`.`id_usuario5`)) AS `autor_5` from ((`trabaprovados` `t` join `sl_cadusu` `c` on((`t`.`email` = `c`.`email`))) join `sl_grupo` `g` on((`g`.`id_artigo` = `t`.`id_artigo`))) where (`t`.`status` = 1) order by `t`.`titulo`;
...
--
-- Índices de tabela `sl_adm`
--
ALTER TABLE `sl_adm`
  ADD PRIMARY KEY (`id_adm`);

--
-- Índices de tabela `sl_artigo`
--
ALTER TABLE `sl_artigo`
  ADD PRIMARY KEY (`id_artigo`), ADD UNIQUE KEY `id` (`id_artigo`);

--
-- Índices de tabela `sl_avaliador`
--
ALTER TABLE `sl_avaliador`
  ADD PRIMARY KEY (`id_avaliador`);

--
-- Índices de tabela `sl_cadusu`
--
ALTER TABLE `sl_cadusu`
  ADD PRIMARY KEY (`id_usuario`), ADD KEY `cargo` (`cargo`);

--
-- Índices de tabela `sl_correcoes`
--
ALTER TABLE `sl_correcoes`
  ADD PRIMARY KEY (`id_correcao`);

--
-- Índices de tabela `sl_grupo`
--
ALTER TABLE `sl_grupo`
  ADD PRIMARY KEY (`id_grupo`);

--
-- Índices de tabela `sl_trabcorrigido`
--
ALTER TABLE `sl_trabcorrigido`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de tabela `sl_artigo`
--
ALTER TABLE `sl_artigo`
  MODIFY `id_artigo` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=69;
--
-- AUTO_INCREMENT de tabela `sl_avaliador`
--
ALTER TABLE `sl_avaliador`
  MODIFY `id_avaliador` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=38;
--
-- AUTO_INCREMENT de tabela `sl_cadusu`
--
ALTER TABLE `sl_cadusu`
  MODIFY `id_usuario` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=135;
--
-- AUTO_INCREMENT de tabela `sl_correcoes`
--
ALTER TABLE `sl_correcoes`
  MODIFY `id_correcao` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=37;
--
-- AUTO_INCREMENT de tabela `sl_grupo`
--
ALTER TABLE `sl_grupo`
  MODIFY `id_grupo` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=78;
--
-- AUTO_INCREMENT de tabela `sl_trabcorrigido`
--
ALTER TABLE `sl_trabcorrigido`
