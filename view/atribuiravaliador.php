				                ...
				                var linha =     	'<div class="panel panel-succsess" style="margin-top:50px">';
				                			...
				                			if(data['trabalhos'][key]['id_avaliador1'] == 0){
				                				...
				                				var select = '<select style="width:100px" class="selectavaliador1">';
				                					...
				                					select+='</select>';
				                					$('#'+data['trabalhos'][key]['id_artigo']+' .avaliador1').append(select+' <botton type="botton" class="btn btn-success glyphicon glyphicon-ok-sign confirma" avaliador="1" idtrab='+data['trabalhos'][key]['id_artigo']+'></botton> <botton type="botton" class="btn btn-primary glyphicon glyphicon-info-sign info" avaliador="1" ok="nao" idtrab='+data['trabalhos'][key]['id_artigo']+'></botton>');
						                		...
						                		var id = 0;
						                			...
						                			$('#'+data['trabalhos'][key]['id_artigo']+' .avaliador1').append(nome+' <button class="btn btn-danger glyphicon glyphicon-pencil editar " idavaliador='+id+' idtrab='+data['trabalhos'][key]['id_artigo']+' avaliador="1"></button> <botton type="botton" class="btn btn-primary glyphicon glyphicon-info-sign info" avaliador="1" ok="sim"  idavaliador='+id+'></botton>');
						                	}
						                	if(data['trabalhos'][key]['id_avaliador2'] == 0){
						                		...
						                		var select = '<select style="width:100px" class="selectavaliador2">';
				                					...
				                					select+='</select>';
				                					$('#'+data['trabalhos'][key]['id_artigo']+' .avaliador2').append(select+' <botton type="botton" class="btn btn-success glyphicon glyphicon-ok-sign confirma" avaliador="2" idtrab='+data['trabalhos'][key]['id_artigo']+'></botton> <botton type="botton" class="btn btn-primary glyphicon glyphicon-info-sign info" avaliador="2" ok="nao" idtrab='+data['trabalhos'][key]['id_artigo']+'></botton>');
						                			...
						                			$('#'+data['trabalhos'][key]['id_artigo']+' .avaliador2').append(nome+' <button class="btn btn-danger glyphicon glyphicon-pencil editar" idavaliador='+id+' idtrab='+data['trabalhos'][key]['id_artigo']+' avaliador="2"></button> <botton type="botton" class="btn btn-primary glyphicon glyphicon-info-sign info" ok="sim" avaliador="2"  idavaliador='+id+'></botton>');
						                	}
				            	...
				            	if(data['avaliadorn']['avaliador'] == 1){
					            	...
					            	var select = '<select style="width:100px" class="selectavaliador1">';
					            		...
					            		var select = '<select style="width:100px" class="selectavaliador2">';
					                				...
					                				select+='</select>';
					                				$('#'+env.idtrab+' .avaliador2').append(select+' <botton type="botton" class="btn btn-success glyphicon glyphicon-ok-sign confirma" avaliador="2" idtrab='+env.idtrab+'></botton> <botton type="botton" class="btn btn-primary glyphicon glyphicon-info-sign info" avaliador="2" ok="nao" idtrab='+env.idtrab+'></botton>');
				            	}
