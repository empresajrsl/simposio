...
<body>
   <div class='container'>
    ...
    <div class='jumbotron'>
        <center>Seu cadastro está quase concluído, após clicar no link o acesso ao sistema será concedido a ".$email." <center>
        ...
        <center><a href='http://sgagro.web1335.kinghost.net/Simposio/submissao/model/confirmacad.php?email= ".$cod."' target='_blank' style='font-size: 20px;'> Confirmar Cadastro </a></center>
    </div>
