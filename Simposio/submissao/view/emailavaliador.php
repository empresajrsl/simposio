...
<body>
   <div class='container'>
    ...
    <div class='jumbotron'>
        <center><h2>Parabéns seu cadastro como Avaliador foi aprovado</h2><center>
        <p> Prezado(a) avaliador(a),

Antecipadamente agradecemos sua disponibilidade em participar como avaliador de trabalhos do I Simpósio em Gestão no Agronegócio.<br>

No interesse de entregar melhores condições para sua avaliação, a Comissão encaminhará um máximo de 5 artigos por avaliador.<br>
Os critérios estabelecidos pelo Comitê Científico estão disponíveis no nosso site.<br>
Como reciprocidade à sua parceria, oferecemos um desconto na sua inscrição, caso tenha condições de participar do evento nos dias 08 a 10 de junho.<br>
<br>
Pedimos a gentileza que as avaliações ocorram dentro do prazo indicado.<br>
<br>
Cordialmente,<br>
<br>
Comissão Organizadora<br></p>
        ...
        <center></center>
        <center><h3> Caso a duvida seja em relação ao evento entre em contato atraves do e-mail:: <b>sgagrofcav@gmail.com</b>  </h3></center>
        </br>
