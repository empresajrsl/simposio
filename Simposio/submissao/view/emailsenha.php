...
<body>
   ...
   <div>;
    <div>;
    <center><h4> Olá!</br></br>
    <p>Foi solicitada uma alteração na senha de acesso do sistema pelo usuario <u>".$email."</u></p>
    ...
    <center><a href='http://sgagro.web1335.kinghost.net/Simposio/submissao/model/confirmaemail.php?email= ".$cod."' target='_blank' style='font-size: 20px;'> Criar nova senha </a></center>
    </div>
